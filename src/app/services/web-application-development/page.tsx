      ...
      <section className="relative w-full h-[280px] flex items-center justify-center bg-[#181F4B] overflow-hidden">
        ...
        <div className="relative z-10 w-full text-center px-4">
          ...
          <p className="text-white/90 text-lg font-medium">
            Building scalable and secure web applications tailored to your needs.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-3 md:px-0 py-12 flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1">
          ...
          <p className="text-[#312C61] text-base md:text-lg leading-relaxed">
            We specialize in developing web applications that are user-friendly, scalable, and secure. From e-commerce to enterprise solutions, we can help you build the right web app for your business needs.
          </p>
        </div>
