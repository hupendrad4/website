...
export default function RequestQuotationPage() {
  return (
    <div className="bg-[#f9f9fa] min-h-screen">
      {/* Top Bar */}
      <div className="bg-[#181F4B] text-white px-4 py-2 flex justify-between items-center text-xs">
        ...
        <div className="hidden md:flex gap-3">
          <span>Follow Us:</span>
          <a href="#" className="hover:text-[#e7b43f]">LinkedIn</a>
          <a href="#" className="hover:text-[#e7b43f]">Twitter</a>
          <a href="#" className="hover:text-[#e7b43f]">Facebook</a>
        </div>
      </div>

      {/* Header & Nav */}
      <header className="bg-white py-4 shadow flex flex-col md:flex-row md:items-center md:justify-between px-6">
        <Link href="/" className="flex items-center gap-2">
          <Image src="/globe.svg" alt="Quorium Logo" width={38} height={38} />
          <span className="text-2xl font-bold text-[#181F4B]">Quorium Technologies</span>
        </Link>
        <nav className="flex gap-6 mt-4 md:mt-0 text-base font-semibold">
          <Link href="/" className="hover:text-[#6d42c7]">Home</Link>
          <Link href="/about" className="hover:text-[#6d42c7]">About</Link>
          <Link href="/services" className="hover:text-[#6d42c7]">Services</Link>
          <Link href="/blog" className="hover:text-[#6d42c7]">Blog</Link>
          <Link href="/contact" className="hover:text-[#6d42c7]">Contact</Link>
          <Link href="/request-quotation" className="ml-4 bg-[#6d42c7] hover:bg-[#e7b43f] text-white px-5 py-2 rounded-full shadow transition font-bold">Request a Quotation</Link>
        </nav>
      </header>
